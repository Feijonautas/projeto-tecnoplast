...
<div class="container contact-form text-center pt-80 pt-xs-60 mt-up">
    <div class="row">
        <div class="col-sm-12">
            ...
            <!-- Contact FORM -->
            <form class="contact-form mt-45" id="contact" action="../grava-contato.php" method="POST">
                <!-- IF MAIL SENT SUCCESSFULLY -->
                <div id="success">
                    <div role="alert" class="alert alert-success">
                        <strong>Sucesso!</strong> nós recebemos sua mensagem. Logo responderemos :).
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <form action="@grava-contato.php" method="<POST></POST>">
                            ...
                            <div class="form-field">
                                <input class="input-sm form-full" id="phone" type="text" name="form-phone" placeholder="Celular">
                            </div>
                        </form>
                    </div>
                    <div class="col-md-12 col-lg-6">
