    ...
    <div class="container">
        <div class="row footer-info mb-60">
            <div class="col-lg-4 col-md-4 col-xs-12 mb-sm-30">
                ...
                <address>
                    <i class="ion-ios-location fa-icons"></i> R. Padre Anchieta, 2050 - Sala 202 - Mercês
                </address>
                <ul class="link-small">
                    <li><a href="mailto:business@support.com"><i class="ion-ios-email fa-icons"></i> contato@modernizecuritiba.com.br</a></li>
            ...
            <div class="col-lg-4 col-md-3 col-xs-12 mb-sm-30">
                ...
                <ul class="link blog-link">
                    ...
                    <li><a href="produtos.php?departamento=persianas"><i class="fa fa-angle-double-right"></i> Produtos</a></li>
                </ul>
            </div>
