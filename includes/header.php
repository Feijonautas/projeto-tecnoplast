<style>
    ...
    .menu {
        border:none;
        border-bottom: 4px solid #f67905;
        border-top: 4px solid #f67905;
        height: 29px;
        position: absolute;
        right: 29px;
        top: 40px;
    ...
    .navigation .sub-nav li a:hover, .navigation .sub-nav li:hover, .navigation ul li a:hover{
        font-weight: 900;
        color: #f67905 !important;
        border-bottom: 1px solid #f67905 !important;
    }
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="top_loction pull-left">
                        <ul>
                            <li><a href="#!"><i class="fa fa-map-marker"></i> R. Padre Anchieta, 2050 - Sala 202 - Mercês</a></li>
                            <li><a href="mailto:contato@modernizecuritiba.com.br"><i class="fa fa-envelope"></i> contato@modernizecuritiba.com.br</a></li>
        ...
        <div class="reletiv_box">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <div class="logo">
                            <a href="index.php"><img src="imagens/identidadeVisual/logo.png" alt=""></a>
                        </div>
                        <!-- Phone Menu button -->
